    ...
    <header className="sticky top-0 z-30 h-16 glass-nav px-4 sm:px-6 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-xl border border-slate-200/80">
          <span className="hidden md:inline text-[10px] font-bold text-slate-500 uppercase px-2">Current Role:</span>
          <div className="rounded-lg bg-white border border-slate-200 px-3 py-1 text-xs font-semibold text-slate-900 capitalize">
            {activeRole}
          </div>
        </div>
